...
class DatabaseC {
  ...
  Future<void> create(String fecha, String padrino, String madrina, String parroquia, String nombre_persona, String diocesis) async {
    try {
      await firestore.collection("comuniones").add({
        'fecha': fecha,
        'padrino': padrino,
        'madrina': madrina,
        'parroquia':parroquia,
